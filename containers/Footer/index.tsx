        ...
        <footer className="footer">
            ...
            <div className="footer-links footer-area">
                ...
                <div className="social-links">
                    <a href="#"><img src="/social/facebook.png"></img></a>
                    <a href="#"><img src="/social/instagram.png"></img></a>
                    <a href="#"><img src="/social/X.png"></img></a>
                    <a href="#"><img src="/social/linkedin.png"></img></a>
                </div>
            </div>
            <div className="footer-links footer-area">
                <h2>
