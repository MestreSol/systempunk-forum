...
const user: User = null; // troque pela sua lógica de auth

function ThemeToggle() {
  const { theme, setTheme } = useTheme();
  const [mounted, setMounted] = React.useState(false); // ✅ agora dentro do componente
...
export const projects: Project[] = [
  {
    ...
    type: "Jogo",
    description:
      "Um jogo de plataforma 2D ambientado no universo Systempunk, onde os jogadores exploram mundos monocromáticos.",
  ...
  },
  {
    ...
    type: "Jogo",
    description:
      "Um jogo de ação, exploração e aventura espacial ambientado no universo Systempunk, onde os jogadores assumem o papel de um explorador espacial.",
  ...
  },
  {
    ...
    type: "Jogo",
    description:
      "Um jogo de simulação de gerenciamento de loja ambientado no universo Systempunk, onde os jogadores assumem o papel de um gerente de loja.",
  ...
  },
  {
    ...
    type: "Livro",
    description:
      "Um Romance ambientado no universo Systempunk, o objetivo dele é iniciar a construção do lore do universo.",
