    ...
    >
      ...
      <CardContent className="p-6">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <Badge
            variant="secondary"
            className="text-xs bg-lime-600/20 text-lime-300 border-lime-500/30"
          >
        ...
        <div className="flex items-center justify-between">
          <span className="text-xs text-zinc-500">Por {article.author}</span>
          <Link href={`/news/${article.slug}`}>
            <Button
              size="sm"
              className="bg-lime-600 hover:bg-lime-700 group-hover:bg-lime-500 transition-colors"
            >
              Ler mais
            </Button>
          </Link>
