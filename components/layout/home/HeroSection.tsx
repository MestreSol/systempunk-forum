      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg lg:text-xl text-zinc-300 mb-12 max-w-3xl mx-auto drop-shadow-md">
            Bem-vindo ao futuro dos jogos independentes. Descubra mundos únicos,
            mecânicas inovadoras e histórias envolventes.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Link href="/news">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white/30 bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 hover:border-white/50 px-8 py-4 text-lg shadow-2xl transition-all duration-300 transform hover:scale-105"
              >
          ...
          <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {stats.slice(0, 4).map((stat, index) => (
              <div
                key={index}
                className="text-center bg-black/20 backdrop-blur-sm rounded-lg p-4 border border-white/10"
              >
