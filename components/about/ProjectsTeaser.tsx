    ...
    <section id="projetos" className="py-16 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-zinc-400 text-lg mb-8 max-w-2xl mx-auto">
          Descubra os jogos, aplicações e experimentos que criamos 
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <Card className="bg-zinc-900 border-zinc-800 hover:border-lime-500/50 transition-colors">
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4">Jogos Indie</h3>
              <p className="text-zinc-300 mb-6">
                Experiências únicas que misturam narrativa envolvente 
                com mecânicas inovadoras
              </p>
          ...
          <Card className="bg-zinc-900 border-zinc-800 hover:border-lime-500/50 transition-colors">
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4">Aplicações Web</h3>
              <p className="text-zinc-300 mb-6">
                Interfaces modernas e funcionais que redefinem 
