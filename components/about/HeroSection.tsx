...
export function HeroSection({ isVisible, onExploreClick, onTeamClick }: HeroSectionProps) {
  return (
    <section className="relative py-20 px-6 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <Badge variant="outline" className="mb-6 text-lime-400 border-lime-400 bg-lime-400/10">
          ...
          <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Onde <span className="text-lime-400 font-semibold">tecnologia</span> encontra{" "}
            <span className="text-cyan-400 font-semibold">criatividade</span> para criar{" "}
            <span className="text-lime-400 font-semibold">experiências digitais únicas</span>
          </p>
