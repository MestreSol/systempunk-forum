...
import { mockArticles, getCategoryLabel, type NewsArticle } from "@/lib/data/newsData";
    ...
    return (
      <div className="min-h-screen bg-zinc-950 text-white">
        ...
        <div className="container mx-auto px-6 py-6">
          <Link href="/news" className="inline-flex items-center text-lime-400 hover:text-lime-300 mb-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 pt-8 border-t border-zinc-800">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-zinc-400 text-sm mb-2">Publicado em {formatDate(article.publishDate)}</p>
                  <p className="text-zinc-500 text-sm">Última modificação: {formatDate(article.lastModified)}</p>
                </div>
                <Link href="/news">
