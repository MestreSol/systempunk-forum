              ...
              <div>
                ...
                <div className="space-y-4 text-zinc-300 leading-relaxed">
                  <p>
                    ...
                    coletivo criativo que nasceu da paixão por unir tecnologia
                    de ponta com narrativas envolventes e design inovador.
                  </p>
                  <p>
                    Somos desenvolvedores, designers, artistas e sonhadores que
                    acreditam no poder da tecnologia para criar experiências que
                    tocam o coração e expandem horizontes.
                  </p>
                  <p>
                    ...
                    <span className="text-lime-400">inovação</span> no centro de
                    tudo.
                  </p>
                </div>
              </div>
              ...
              <Card className="bg-zinc-900 border-zinc-800">
                ...
                <CardContent>
                  <p className="text-zinc-300">
                    Criar experiências digitais que inspirem, emocionem e
                    conectem pessoas através da tecnologia e criatividade.
                  </p>
                </CardContent>
              </Card>
          ...
          <TabsContent value="tecnologias" className="mt-8">
            <div className="text-center mb-8">
              ...
              <p className="text-zinc-400 text-lg">
                Utilizamos as melhores tecnologias para criar experiências
                incríveis
              </p>
            </div>
