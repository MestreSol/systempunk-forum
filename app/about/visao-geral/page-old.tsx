    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="py-12 px-6 bg-gradient-to-br from-zinc-900 to-zinc-950">
        <div className="max-w-6xl mx-auto">
          <Link href="/about/introducao" className="inline-flex items-center text-lime-400 hover:text-lime-300 mb-6">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-lg">
                  Uma análise completa do SystemPunk: conquistas, capacidades e direção futura
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <Tabs value={activeSection} onValueChange={setActiveSection} className="space-y-8">
          <TabsList className="grid w-full grid-cols-5 bg-zinc-900 border-zinc-800">
            ...
            <TabsTrigger value="capabilities" className="data-[state=active]:bg-lime-600">
              <Zap className="w-4 h-4 mr-2" />
              Capacidades
            </TabsTrigger>
            <TabsTrigger value="achievements" className="data-[state=active]:bg-lime-600">
          ...
          <TabsContent value="overview" className="space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="bg-zinc-900 border-zinc-800">
                ...
                <CardContent>
                  <p className="text-zinc-300 leading-relaxed">
                    Criar experiências digitais inovadoras que conectam tecnologia e criatividade, 
                    inspirando e engajando comunidades através de jogos e aplicações únicas.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-zinc-900 border-zinc-800">
                ...
                <CardContent>
                  <p className="text-zinc-300 leading-relaxed">
                    Ser reconhecido como um estúdio pioneiro na intersecção entre arte e tecnologia, 
                    criando o futuro das experiências interativas digitais.
                  </p>
                </CardContent>
              </Card>
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="bg-zinc-800 rounded-lg p-4">
                    ...
                    <h3 className="text-lg font-semibold text-white mb-2">Neon Runners</h3>
                    <p className="text-zinc-400 text-sm mb-4">
                      Jogo de corrida cyberpunk com elementos de RPG
                    </p>
                    <div className="flex items-center gap-2">
                      <Star className="w-4 h-4 text-yellow-400" />
                      <span className="text-sm text-zinc-300">4.8/5 • 15K downloads</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-zinc-800 rounded-lg p-4">
                    ...
                    <h3 className="text-lg font-semibold text-white mb-2">DevTools Suite</h3>
                    <p className="text-zinc-400 text-sm mb-4">
                      Conjunto de ferramentas para desenvolvedores indie
                    </p>
                    <div className="flex items-center gap-2">
                      <Download className="w-4 h-4 text-green-400" />
                      <span className="text-sm text-zinc-300">8.2K downloads</span>
                    </div>
                  </div>

                  <div className="bg-zinc-800 rounded-lg p-4">
                    <Smartphone className="w-12 h-12 text-purple-400 mb-4" />
                    <h3 className="text-lg font-semibold text-white mb-2">Creative Hub</h3>
                    <p className="text-zinc-400 text-sm mb-4">
                      App mobile para colaboração criativa
                    </p>
                    <div className="flex items-center gap-2">
                      <Users className="w-4 h-4 text-blue-400" />
                      <span className="text-sm text-zinc-300">2.1K usuários ativos</span>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="capabilities" className="space-y-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-lime-200 mb-4">Nossas Capacidades</h2>
              <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
                Uma combinação única de habilidades técnicas e criativas que nos permite 
                criar experiências excepcionais
              </p>
            </div>
          ...
          <TabsContent value="achievements" className="space-y-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-lime-200 mb-4">Conquistas e Marcos</h2>
              <p className="text-zinc-400 text-lg">
          ...
          <TabsContent value="future" className="space-y-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-lime-200 mb-4">Visão de Futuro</h2>
              <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
                Nossos planos, ambições e a direção que estamos tomando para os próximos anos
              </p>
            </div>
            ...
            <Card className="bg-gradient-to-r from-lime-900/20 to-cyan-900/20 border-lime-500/30">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-zinc-300 mb-6 max-w-2xl mx-auto">
                  Estamos sempre em busca de talentos apaixonados por tecnologia e criatividade. 
                  Venha fazer parte do futuro das experiências digitais!
                </p>
